      ...
      <div className="min-h-screen flex items-center justify-center px-4 relative z-10">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-3xl font-extrabold text-medical-text drop-shadow-sm">Admin Portal</h1>
            <p className="text-medical-text-secondary/90 mt-2 font-medium">AIIMS Delhi — Administrator Login</p>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-xl btn-super-glass text-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden bg-gradient-to-r from-violet-500 to-purple-400"
              >
